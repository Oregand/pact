...
describe("resolver-tests", function() {
  describe("The Promise Constructor", function() {
    it("has `Object.getPrototypeOf(pact) === Promise.prototype`", function() {
      assert(Object.getPrototypeOf(pact) === Promise.prototype);
    });
    it("has `pact.constructor === Promise`", function() {
      assert(pact.constructor === Promise);
    });
    it("has `pact.constructor === Promise.prototype.constructor`", function() {
      assert(pact.constructor === Promise.prototype.constructor);
    });
    ...
    describe("if resolver is a function", function() {
      it("must be called with the pact's resolver arguments", function(done) {
